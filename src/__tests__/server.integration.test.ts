...
import type { Constellation } from '../api/astronomy/v1/models/Constellation.js'
import type { SapEventCatalog } from '../event/shared/SapEventCatalog.js'
import type { ErrorItem } from '../shared/model/ErrorResponses.js'
